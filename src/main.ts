...
dialog('This script will sync the Rating, BPM and Playlists from Rekordbox to Apple Music. Please do not use Apple Music while this script is running.\n\nNow select your XML Library File exported from Rekordbox.')
...
delay(1)
notify('Rekordbox Library', `Loading Tracks and Playlists... \nThis might take some time`)
